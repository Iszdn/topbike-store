...
import BlogsDrop from "../../BlogsNav";
          ...
          <div className="dropdown-menu home list-woman shop show">
            <div className="row">
              <div className="col-lg-4 col-md-4 nn">
                <Link to="/">
                  <img
                    src="https://topbike-store-demo.myshopify.com/cdn/shop/files/home1_79702614-1d24-4067-9a69-2ee018b89d3b.jpg?v=1613577776"
                    alt=""
                  />
                </Link>
              </div>
              <div className="col-lg-4 col-md-4 nn">
                <img
                  src="https://topbike-store-demo.myshopify.com/cdn/shop/files/home2_411f599e-59e9-4ba9-8de2-3d92ad6282c6.jpg?v=1613577776"
                  alt=""
                />
              </div>
              <div className="col-lg-4 col-md-4 nn">
                <img
                  src="https://topbike-store-demo.myshopify.com/cdn/shop/files/home3_8ef816a2-0531-4578-a497-139164f99d10.jpg?v=1613577776"
                  alt=""
                />
              </div>
              <div className="col-lg-4 col-md-4 nn">
                <img
                  src="https://topbike-store-demo.myshopify.com/cdn/shop/files/home4_3c5e0131-1366-4c93-a41b-9f35d04f4449.jpg?v=1613577776"
                  alt=""
                />
              </div>
              <div className="col-lg-4 col-md-4 nn">
                <img
                  src="https://topbike-store-demo.myshopify.com/cdn/shop/files/home5_6e4f660a-7d2a-4559-869e-761708fefc9a.jpg?v=1613577776"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="dropdown-menu featured list-woman shop show">
            <div className="row">
              <div className="col-lg-12 video col-md-12">
                <iframe
                  src="https://player.vimeo.com/video/203552982?background=1&amp;quality=1080p&amp;loop=1"
                  frameborder="0"
          ...
          <div className="dropdown-menu pages list-woman shop show">
            <div className="row shop-drop">
              ...
              <ul className="col-lg-4 col-md-4">
                ...
                <li>
                  <Link to="/login">Login/RegisterN</Link>
                </li>
              </ul>
              <ul className="col-lg-4 col-md-4">
